...
public class WalletFile {
    ...
    public static class Crypto {
        ...
        @JsonTypeInfo(
                ...
                property = "kdf")
        @JsonSubTypes({
                @JsonSubTypes.Type(value = Aes128CtrKdfParams.class, name = SecretStorage.AES_128_CTR),
                @JsonSubTypes.Type(value = ScryptKdfParams.class, name = SecretStorage.SCRYPT)
        })
