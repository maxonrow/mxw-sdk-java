 ...
 * Bech32
 *
 * implementation and adapted from <a href="https://github.com/bitcoinj/bitcoinj/blob/master/core/src/main/java/org/bitcoinj/core/Bech32.java">bitcoinj</a>
 */
public class Bech32 {
    ...
    public static String encode(String hrp, final byte[] values) {
        verifyPrecondition(hrp.length() >= 1, "Human-readable part is too short");
        verifyPrecondition(hrp.length() <= 83, "Human-readable part is too long");
     ...
     * from https://github.com/bitcoinj/bitcoinj/blob/master/core/src/main/java/org/bitcoinj/core/SegwitAddress.java
     */
    ...
    public static byte[] toWords(final byte[] in){
        return convertBits(in, 0, in.length,8, 5, true);
    }

    public static byte[] fromWords(final byte[] in) {
        return convertBits(in, 0, in.length, 5, 8, false);
    }
